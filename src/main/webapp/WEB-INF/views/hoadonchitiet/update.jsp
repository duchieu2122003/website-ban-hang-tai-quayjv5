...
<head>
    ...
    <title>Sửa thông tin hóa đơn chi tiết</title>
...
<section class="container">
    <h1>Sửa thông tin hóa đơn chi tiết</h1>
    <br><br>
    <form:form action="/admin/hoa-don-chi-tiet/update/${hoaDonChiTiet.idHoaDon}/${hoaDonChiTiet.idChiTietSanPham}"
               method="post" modelAttribute="hoaDonChiTiet">
